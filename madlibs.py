#it was a (adjective 1) day at school, and (male teacher) was preparing his (noun 1) 
# for his (class) class. However, when class started, (name) started to (verb 1) 
# (adverb 1), catching the teacher by surprise. "You are going to (location) 
# for (time), because you are (adjective 2)!" (male teacher) said. 
